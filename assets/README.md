# Assets — BeatOnStep site

Images utilisées par le site public. Ne pas empiler de fichiers à la racine du repo.
...
| `screenshots/sources/` | Captures par source (`mix/`, `phone/`, `youtube/`, `apple-music/`, `spotify/`, `deezer/`) |
